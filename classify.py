...
train_imgs = torch.load('img_embedding/test_'+shot+'shot.pt')
train_y = torch.load(data_root + 'test_data_' + shot + 'shot.pt')['label']
train_imgs = train_imgs.to(device)
train_y = train_y.to(device)
with open('descriptors_food101.json', 'r') as fp:
